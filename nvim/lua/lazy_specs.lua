...
local plugin_specs = {
	...
	-- Markdown live preview
	{
		...
		keys = {
			{ "<leader>mp", function() require("md-render").preview.show({ max_width = math.floor(vim.o.columns * 0.85) }) end, desc = "Markdown preview (toggle)" },
			{ "<leader>mt", function() require("md-render").preview.show_tab({ max_width = math.floor(vim.o.columns * 0.85) }) end, desc = "Markdown preview in tab (toggle)" },
		},
	},
	...
	-----------------------------------------------------------------------
	-- AI Assistants (loaded from local config if present)
	-----------------------------------------------------------------------
	...
	-- URL opener
	{
		...
		config = function()
			local ok, url = pcall(require, "url-open")
			if ok then
				url.setup({})
			end
		end,
	...
	-- Cmdline completion (noice.nvim provides this if needed)
	-- wilder.nvim removed: unmaintained and requires pynvim
	-- Vim script debug
	...
	-----------------------------------------------------------------------
	-- Colorschemes (loaded eagerly — active theme needs to be available)
	-----------------------------------------------------------------------
